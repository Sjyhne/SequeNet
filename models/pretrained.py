...
def resnet_pspnet_VOC12_v0_1():
    ...
    latest_weights = get_file(model_url.split("/")[-1], model_url)
...
def pspnet_101_cityscapes():
    ...
    latest_weights = get_file("pspnet101_cityscapes.h5", model_url)
...
def pspnet_101_voc12():
    ...
    latest_weights = get_file("pspnet101_voc2012.h5", model_url)
