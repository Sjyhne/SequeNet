...
def swin(num_classes, input_height, input_width):
    ...
    num_heads = [8, 8, 16, 16]   # number of attention heads per down/upsampling level
    window_size = [8, 4, 2, 2] # the size of attention window per down/upsampling level
